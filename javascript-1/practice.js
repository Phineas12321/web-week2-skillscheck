...
// Code Here
doubled = myNumbers.map((e, i, arr) => e*2)
...
// Code Here
filtered = myNumbers.filter((e, i, arr) => e > 100)
...
// Code Here
total = myNumbers.reduce((acc, e, i, arr) => acc + e, 0)
...
// Code Here
forTheLoveOfGeorge = notGeorge.map((e, i, arr) => e = 'George')
...
// Code Here
enemies = people.filter((e, i, arr) => !e.friend)
...
// Code Here
totallyAwesome = people.reduce((acc, e, i, arr) => acc + e.awesomeLevel, 0)